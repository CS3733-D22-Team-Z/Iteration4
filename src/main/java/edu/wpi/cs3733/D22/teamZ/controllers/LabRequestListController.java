...
public class LabRequestListController implements Initializable, IMenuAccess {
  ...
  private List<LabServiceRequest> rawRequests; // change
  ...
  public LabRequestListController() { // change
  ...
  public String getMenuName() {
    return "Lab Service Request List";
  } // change
  ...
  public void createRRList() {
    ...
    for (LabServiceRequest request : rawRequests) { // change
      requests.add(
          new RequestRow( // Use detailRetrievers
  ...
  public void loadRow(String reqID) {
    ...
    LabServiceRequest selectedReq = getRequestFromID(reqID); // change
  ...
  public void loadRequests() {
    rawRequests = FacadeDAO.getInstance().getAllLabServiceRequests(); // change
  }

  public LabServiceRequest getRequestFromID(String MeqID) { // change
    return FacadeDAO.getInstance().getLabServiceRequestByID(MeqID); // change
  }
  ...
  public void exportToCSV(ActionEvent actionEvent) {
    ...
    facadeDAO.exportLabRequestsToCSV(file); // change
  }
  ...
  private static class RequestRow {
    ...
    public RequestRow(String newId, String newType, String newIssuer, String newStatus) {
      ...
      labType = new SimpleStringProperty(newType);
  ...
  private interface RequestFunc {
    String call(LabServiceRequest request); // change
  }
}
