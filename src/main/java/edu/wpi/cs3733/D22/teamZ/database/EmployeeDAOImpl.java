...
public class EmployeeDAOImpl implements IEmployeeDAO{
    ...
    public List<Employee> getAllEmployees() {
        try {
            ...
            while (rset.next()) {
                ...
                Employee emp =
                        new Employee(employeeID, name, accessType, username, password);
    ...
    public boolean updateEmployee(Employee emp) {
        try {
            PreparedStatement stmt =
                    connection.prepareStatement("UPDATE Employee SET NAME=?, ACCESSTYPE =? WHERE EMPLOYEEID =?");
    ...
    public boolean deleteEmployee(Employee emp) {
        try {
            PreparedStatement stmt = connection.prepareStatement("DELETE FROM EMPLOYEE WHERE EmployeeID=?");
            stmt.setString(1, emp.getEmployeeID());
            stmt.executeUpdate();
        } catch (SQLException e) {
            System.out.println("Statement failed");
