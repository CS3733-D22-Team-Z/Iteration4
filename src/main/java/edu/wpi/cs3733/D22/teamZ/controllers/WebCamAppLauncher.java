...
/**
 * This example demonstrates how to use Webcam Capture API via FXML in a JavaFX application.
 *
...
public class WebCamAppLauncher extends Application {
  ...
  public void start(Stage primaryStage) {
    ...
    try {
      root =
          FXMLLoader.load(
              getClass().getResource("edu/wpi/cs3733/D22/teamZ/views/WebCamPreview.fxml"));
