...
public class MealChartController implements Initializable, IMenuAccess {
  ...
  public void initialize(URL location, ResourceBundle resources) {
    ...
    series.setName("Time to Submit Request");
    int count = 0;
    for (MealServiceRequest medReq : facadeDAO.getAllMealServiceRequests()) {
