...
//  // ArrayList<>());
//  private ObservableList<Location> totalLocations = FXCollections.observableList(new
// ArrayList<>());
...
//                    "DEPT", "HALL", "ELEV", "STOR", "EXIT", "INFO", "RETL", "SERV", "STAI",
// "BATH", "LABS",
//                    "PATI"));
...
//  }
//
//  // when medical equipment request button is clicked on menu navigate to medical equipment
// request
//  // page
//  @FXML
...
//    map.setImage(
//            new Image("edu/wpi/cs3733/D22/teamZ/images/" + floorField.getValue().toString() +
// ".png"));
//    // showLocations(nFloor);
//
//    // addLocationPane.setVisible(false);
